...
--EMP 테이블에 사원 한 명 추가하기
--EMPNO 는 9999, ENAME 은 자유롭게, JOB 은 FREE, 
--매니저 없음, 입사일은 오늘날짜, 샐러리 1000, COMM 없음, DEPTNO 없음

INSERT INTO EMP VALUES(9999, 'ANNIE', 'FREE', NULL, SYSDATE, 1000, NULL, NULL);
SELECT * FROM EMP;
COMMIT;
