...
public class Malaworld {
	...
	while(true) {
		...
		if(spicy == 1) {
			...
			System.out.println();
			System.out.println(">> 1~3번 중에 선택해 주세요.");
			continue;
		}
		...
		System.out.println("(1) 고기, (2) 해산물, (3) 넣지 않기 ");
		int meat = sc.nextInt();
		...
		if(meat == 1) {
			...
			System.out.println();
			System.out.println(">> 아무것도 넣지 않습니다.");
			System.out.println();
		}
		...
		System.out.println("(5개 미만까지는 15000원, 10개 미만까지는 30000원 입니다.) : ");
		int ing = sc.nextInt();
		System.out.println();
		System.out.print(">> ");
		...
		if(meat == 1) {
			...
			System.out.print("고기 또는 해산 물은 넣지 않고, ");
		}
